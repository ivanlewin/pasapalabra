...
def validar_linea(diccionario: tipos.configuracion, linea: str) -> tipos.configuracion:
    '''
    ...
    * Brizuela, Natanael Daniel
    ...
    {'LONGITUD_PALABRA_MINIMA': {'valor': 4, 'origen': 'Elección'}}
    ...
    try:
        if nombre in diccionario.keys():
            diccionario[nombre] = {'valor': int(valor), 'origen': 'Elección'}
    except ValueError:
        pass
...
def crear_diccionario_configuracion() -> tipos.configuracion:
    '''
